...
export class ProveedoresService {
  ...
  provURL = 'https://comprasapp-571a0.firebaseio.com/proveedores.json';
  proURL = 'https://comprasapp-571a0.firebaseio.com/proveedores';
  ...
  postProveedor(proveedor: any) {
    ...
    return this.http.post(this.provURL, newpres, {headers}).pipe(
      map(res => {
